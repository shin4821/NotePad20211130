//OnSaveByDifferentNameButtonClicked.cpp
...
OnSaveByDifferentNameCommand::OnSaveByDifferentNameCommand(NotePadForm* notePadForm)
	:Command(notePadForm) {
}

OnSaveByDifferentNameCommand::~OnSaveByDifferentNameCommand() {
}

void OnSaveByDifferentNameCommand::Execute() {
	...
	if (IDOK == dlg.DoModal()) {
		...
		//(21.11.15.추가) 현재 자동개행버튼이 설정되어있으면 풀어준다.
