...
SelectEndDoc::SelectEndDoc(NotePadForm* notePadForm)
	:KeyAction(notePadForm) {
}

SelectEndDoc:: ~SelectEndDoc() {
}

void SelectEndDoc::KeyDown() {
	Long beforeCurrentX;
	Long beforeCurrentY;
	Long currentX;
	Long currentY;
	...
	KeyAction* keyAction = new EndDocKeyAction(this->notePadForm);
	keyAction->KeyDown();
