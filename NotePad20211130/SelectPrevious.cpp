...
SelectPrevious::SelectPrevious(NotePadForm* notePadForm)
...
void SelectPrevious::KeyDown() {
	...
	//2. 기존 Previous 클래스의 keyDown 함수와 동일하게 만들어준다.
	KeyAction* keyAction = new Previous(this->notePadForm);
	keyAction->KeyDown();
	...
	//4. Previous 후의 좌표를 SelectWords의 endX,Y에 적는다.
