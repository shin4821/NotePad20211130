...
SelectPreviousWord::SelectPreviousWord(NotePadForm* notePadForm)
...
void SelectPreviousWord::KeyDown() {
	Long beforeCurrentX;
	Long beforeCurrentY;
	Long currentX;
	Long currentY;
	...
	KeyAction* keyAction = new PreviousWord(this->notePadForm);
	keyAction->KeyDown();
